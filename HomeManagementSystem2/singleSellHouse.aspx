<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="singleSellHouse.aspx.cs" Inherits="HomeManagementSystem2.singleSellHouse" %>
...
<body>
    ...
    <div id ="content">
        <div id ="propNav">
            ...
            >
            <a href="#"><asp:Label runat ="server" ID="Label1" OnLoad="Txt_Load"/></a>
            >
                        ...
                        <ul class="prop_basic">
                            ...
                            <li class="prop_basic_right">
                                <div class="list_spstyle">单价：
                                    <asp:Label runat ="server" ID="perTxt" OnLoad="Txt_Load"/>元/平方米
                                </div>
                                ...
                                <div class="list_spstyle">建造年代：<asp:Label runat ="server" ID="yearTxt" OnLoad="Txt_Load"/></div>
                            </li>
                        </ul>
        ...
        <div id ="extra-propview">
            <p class="tag">房源描述</p>    
            <div class="descriBox"><asp:Label class="descriBox" runat ="server" ID="descrTxt" OnLoad="Txt_Load"/></div>
            <p class="tag">房源组图</p>
