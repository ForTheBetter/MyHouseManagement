<%@ Page Title="" Language="C#" MasterPageFile="~/MuBanYe/base.Master" AutoEventWireup="true" CodeBehind="Oldhouse.aspx.cs" Inherits="HomeManagementSystem2.Oldhouse" %>
...
<div class="listing">
    <div class="top_bar glb_xp_topBar">
        <div class="text fl" >共有<span class="show_total" id="show_total" runat="server"> 2 </span>个符合要求的上海二手房楼盘
